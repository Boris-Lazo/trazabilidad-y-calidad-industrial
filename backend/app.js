...
const extrusionPERoutes  = require('./domains/production/extrusionPE.routes');
const peletizadoRoutes   = require('./domains/production/peletizado.routes');
const tareasGeneralesRoutes = require('./domains/production/tareasGenerales.routes');
