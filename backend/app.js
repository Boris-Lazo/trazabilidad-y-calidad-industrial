...
const bitacoraRoutes = require('./domains/production/execution/bitacora.routes');
const ordenProduccionRoutes = require('./domains/production/orders/ordenProduccion.routes');
const incidenteRoutes = require('./domains/production/incidents/incidente.routes');
...
const telaresRoutes = require('./domains/production/processes/telares/telares.routes');
const laminadoRoutes = require('./domains/production/processes/laminado/laminado.routes');
const imprentaRoutes = require('./domains/production/processes/imprenta/imprenta.routes');
const conversionRoutes = require('./domains/production/processes/conversion/conversion.routes');
const vestidosRoutes = require('./domains/production/processes/vestidos/vestidos.routes');
const linerPERoutes    = require('./domains/production/processes/linerPE/linerPE.routes');
const extrusionPERoutes  = require('./domains/production/processes/extrusionPE/extrusionPE.routes');
const peletizadoRoutes   = require('./domains/production/processes/peletizado/peletizado.routes');
const tareasGeneralesRoutes = require('./domains/production/tasks/tareasGenerales.routes');
const extrusorPPRoutes = require('./domains/production/processes/extrusorPP/extrusorPP.routes');
...
const planningRoutes = require('./domains/production/scheduling/planning.routes');
const procesosRoutes = require('./domains/production/processes/procesos.routes');
const maquinaRoutes = require('./domains/production/machines/maquina.routes');
const paroRoutes = require('./domains/production/incidents/paro.routes');
...
app.use('/api/extrusion-pe', authMiddleware, bootstrapGuard, extrusionPERoutes);
app.use('/api/peletizado',   authMiddleware, bootstrapGuard, peletizadoRoutes);
app.use('/api/tareas-generales', authMiddleware, bootstrapGuard, tareasGeneralesRoutes);
