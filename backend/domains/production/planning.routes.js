...
router.post('/update-order', authorize(PERMISSIONS.ASSIGN_OPERATIONS), planningController.updateOrder);
router.post('/assign-personnel', authorize(PERMISSIONS.ASSIGN_OPERATIONS), planningController.assignPersonnel);
router.post('/update-personnel', authorize(PERMISSIONS.ASSIGN_OPERATIONS), planningController.updatePersonnel);
