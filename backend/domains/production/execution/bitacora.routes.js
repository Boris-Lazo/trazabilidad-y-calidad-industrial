...
const PlanningRepository = require('../scheduling/planning.repository');
const PlanningService = require('../scheduling/planning.service');
...
router.get('/activa', bitacoraController.getBitacoraActiva);
