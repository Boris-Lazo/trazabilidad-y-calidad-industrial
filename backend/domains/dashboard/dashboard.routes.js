...
const OrdenProduccionRepository = require('../production/orders/ordenProduccion.repository');
const LineaEjecucionRepository = require('../production/execution/lineaEjecucion.repository');
const RegistroTrabajoRepository = require('../production/execution/registroTrabajo.repository');
const IncidenteRepository = require('../production/incidents/incidente.repository');
