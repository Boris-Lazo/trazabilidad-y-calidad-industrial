...
const qualityRoutes = require('../domains/quality/quality.routes');
const dashboardRoutes = require('../domains/dashboard/dashboard.routes');
const resourceRoutes = require('../domains/resources/resources.routes');
...
app.use('/api/lotes', authMiddleware, qualityRoutes); // Compatible con rutas previas
app.use('/api/muestras', authMiddleware, qualityRoutes); // Compatible con rutas previas
app.use('/api/recursos', authMiddleware, resourceRoutes);
app.use('/api/consumos', authMiddleware, resourceRoutes);
