...
const runFullSchema = () => {
  db.serialize(() => {
    ...
    db.run(`CREATE TABLE IF NOT EXISTS conversion_consumo_rollo (
        id                   INTEGER PRIMARY KEY AUTOINCREMENT,
        bitacora_id          INTEGER NOT NULL,
        maquina_id           INTEGER NOT NULL,
        orden_id             INTEGER NOT NULL,
    ...
    db.run(`CREATE TABLE IF NOT EXISTS conversion_muestras_calidad (
        id                   INTEGER PRIMARY KEY AUTOINCREMENT,
        bitacora_id          INTEGER NOT NULL,
        maquina_id           INTEGER NOT NULL,
        orden_id             INTEGER NOT NULL,
    ...
    db.run(`CREATE TABLE IF NOT EXISTS conversion_muestra_fisica (
        id                   INTEGER PRIMARY KEY AUTOINCREMENT,
        bitacora_id          INTEGER NOT NULL,
        maquina_id           INTEGER NOT NULL,
        orden_id             INTEGER NOT NULL,
    ...
    db.run(`CREATE TABLE IF NOT EXISTS conversion_defectos (
        id                        INTEGER PRIMARY KEY AUTOINCREMENT,
        bitacora_id               INTEGER NOT NULL,
        maquina_id                INTEGER NOT NULL,
        orden_id                  INTEGER NOT NULL,
